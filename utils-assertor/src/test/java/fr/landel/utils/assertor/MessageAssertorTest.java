...
public class MessageAssertorTest {
    ...
    public void testToString() {
        ...
        assertEquals("[locale: fr_FR, arguments: arg1, arg2]", MessageAssertor.of(Locale.FRANCE, null, new String[] {"arg1", "arg2"}).toString());
        ...
        assertEquals("[message: message, arguments: arg1, arg2]", MessageAssertor.of(null, "message", new String[] {"arg1", "arg2"}).toString());
