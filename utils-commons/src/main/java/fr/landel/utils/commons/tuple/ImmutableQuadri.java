 ...
 *
 */
public final class ImmutableQuadri<T> extends AbstractImmutableQuadri<T> {
     ...
     */
    public ImmutableQuadri(final T first, final T second, final T third, final T fourth) {
