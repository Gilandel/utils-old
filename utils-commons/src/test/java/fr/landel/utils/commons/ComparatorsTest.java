...
public class ComparatorsTest {
    ...
    public void testByte() {
        ...
        List<Byte> bytesSorted = bytes.stream().sorted(Comparators.BYTE).collect(Collectors.toList());
        ...
        bytesSorted = bytes.stream().sorted(Comparators.BYTE_REVERSE).collect(Collectors.toList());

        assertEquals(Byte.valueOf((byte) 2), bytesSorted.get(2));
        assertEquals(Byte.valueOf((byte) 3), bytesSorted.get(1));
        assertEquals(Byte.valueOf((byte) 5), bytesSorted.get(0));

        assertEquals(Integer.MIN_VALUE, Comparators.BYTE.compare(null, (byte) 5));
        assertEquals(Integer.MAX_VALUE, Comparators.BYTE.compare((byte) 5, null));

        assertEquals(Integer.MAX_VALUE, Comparators.BYTE_REVERSE.compare(null, (byte) 5));
        assertEquals(Integer.MIN_VALUE, Comparators.BYTE_REVERSE.compare((byte) 5, null));
    }
    ...
    public void testShort() {
        ...
        List<Short> shortsSorted = shorts.stream().sorted(Comparators.SHORT).collect(Collectors.toList());
        ...
        shortsSorted = shorts.stream().sorted(Comparators.SHORT_REVERSE).collect(Collectors.toList());
    ...
    public void testChar() {
        ...
        List<Character> charsSorted = chars.stream().sorted(Comparators.CHAR).collect(Collectors.toList());
        ...
        charsSorted = chars.stream().sorted(Comparators.CHAR_REVERSE).collect(Collectors.toList());
    ...
    public void testInteger() {
        ...
        List<Integer> integersSorted = integers.stream().sorted(Comparators.INTEGER).collect(Collectors.toList());
        ...
        integersSorted = integers.stream().sorted(Comparators.INTEGER_REVERSE).collect(Collectors.toList());
    ...
    public void testLong() {
        ...
        List<Long> longsSorted = longs.stream().sorted(Comparators.LONG).collect(Collectors.toList());
        ...
        longsSorted = longs.stream().sorted(Comparators.LONG_REVERSE).collect(Collectors.toList());
    ...
    public void testFloat() {
        ...
        List<Float> floatsSorted = floats.stream().sorted(Comparators.FLOAT).collect(Collectors.toList());
        ...
        floatsSorted = floats.stream().sorted(Comparators.FLOAT_REVERSE).collect(Collectors.toList());
    ...
    public void testDouble() {
        ...
        List<Double> doublesSorted = doubles.stream().sorted(Comparators.DOUBLE).collect(Collectors.toList());
        ...
        doublesSorted = doubles.stream().sorted(Comparators.DOUBLE_REVERSE).collect(Collectors.toList());
    ...
    public void testBigInteger() {
        ...
        List<BigInteger> bigIntegersSorted = bigIntegers.stream().sorted(Comparators.BIG_INTEGER).collect(Collectors.toList());
        ...
        bigIntegersSorted = bigIntegers.stream().sorted(Comparators.BIG_INTEGER_REVERSE).collect(Collectors.toList());
    ...
    public void testBigDecimal() {
        ...
        List<BigDecimal> bigDecimalsSorted = bigDecimals.stream().sorted(Comparators.BIG_DECIMAL).collect(Collectors.toList());
        ...
        bigDecimalsSorted = bigDecimals.stream().sorted(Comparators.BIG_DECIMAL_REVERSE).collect(Collectors.toList());
    ...
    public void testString() {
        ...
        List<String> stringsSorted = strings.stream().sorted(Comparators.STRING).collect(Collectors.toList());

        assertEquals("a1a", stringsSorted.get(0));
        assertEquals("a1b", stringsSorted.get(1));
        assertEquals("a1e", stringsSorted.get(2));

        stringsSorted = strings.stream().sorted(Comparators.STRING_REVERSE).collect(Collectors.toList());
