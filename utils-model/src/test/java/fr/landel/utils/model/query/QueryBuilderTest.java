...
public class QueryBuilderTest {
    ...
    public void testGetAlias() {
        ...
        System.out.println(Arrays.asList(QueryBuilderTest.split("test;2;dd;;h;", ';', true)));
        System.out.println(Arrays.asList(QueryBuilderTest.split("test;2;dd;;h;", ';', false)));
        ...
        for (int j = 0; j < 5; j++) {
            ...
            for (String test : list) {
                if (QueryBuilderTest.indexOf(test, '1', 0) > -1) {
                    res = test.split("1");
                }
            }
            diff = System.currentTimeMillis() - start;

            System.out.println("index gilles: " + diff);
            ...
            System.out.println("split: " + diff);

            start = System.currentTimeMillis();
            for (String test : list) {
                res = QueryBuilderTest.split(test, '1', true);
            }
            diff = System.currentTimeMillis() - start;

            System.out.println("split worker: " + diff);
        }
    }
    ...
    private static String[] split(final String str, final char separatorChar, final boolean preserve) {
        ...
        while ((next = QueryBuilderTest.indexOf(str, separatorChar, off)) != -1) {
